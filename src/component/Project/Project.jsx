...
const Project = () => {
  return (
    <section className=" py-20 mx-auto w-full  px-5 lg:px-10 2xl:px-0 2xl:w-full">
      <div className="text-center">
        <h2 className="font-lato font-bold text-4xl leading-[1em] md:leading-[0.8em] md:text-7xl text-[#F5F5F5]">
          Project
        </h2>
      </div>
      <div className="pt-7">
        <h3 className="text-xl leading-[1.5em] text-center md:text-left text-skin-purple py-4">
        ...
        <div className="grid grid-cols-1 gap-9 lg:grid-cols-2">
          ...
          <div className="relative pt-5 mx-auto ">
            <div className="rounded-lg  aspect-w-12 aspect-h-9 w-[336px] md:w-[420px] z-20  bg-white h-[317px]">
              <img src={image} className="p-2" alt="solve3" />
            </div>
